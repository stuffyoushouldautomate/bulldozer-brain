...
**Advanced Research Platform for Local 825**

Bulldozer Brain uses a variety of powerful AI models to generate in-depth research reports in just a few minutes. It leverages advanced "Thinking" and "Task" models, combined with an internet connection, to provide fast and insightful analysis on a variety of topics. **Your privacy is paramount - all data is processed and stored locally.**

## ✨ Features

- **Rapid Research:** Generates comprehensive research reports in about 2 minutes, significantly accelerating your research process.
- **Company Profile Generator:** Specialized mode for generating comprehensive company research reports for Local 825 union organizing efforts, including construction industry analysis, safety compliance, union relationships, and strategic pressure points.
...
- **Support for SaaS and MCP:** You can use this project as a research service (SaaS) through the SSE API, or use it in other AI services through MCP service.
...
Bulldozer Brain includes a specialized **Company Profile Generator** mode designed specifically for union organizing efforts. This feature provides comprehensive analysis of construction companies with focus on:

### Key Research Areas
- **Corporate Structure & Operations**: Company history, ownership, subsidiaries, facility locations
- **Leadership & Management**: Key executives, management philosophy, political affiliations
- **Workforce Analysis**: Employee count, union representation, working conditions, safety record
- **Labor Relations Profile**: Union history, anti-union tactics, NLRB cases, bargaining history
- **Projects & Contracts**: Current projects, government contracts, bidding patterns, PLAs
- **Safety & Compliance**: OSHA violations, safety performance, environmental compliance
- **Financial Profile**: Revenue trends, funding sources, financial vulnerabilities
- **Political & Community Connections**: Political contributions, lobbying, industry associations
- **Market Position & Competition**: Market share, competitors, competitive advantages
- **Strategic Pressure Points**: Client pressure opportunities, financial leverage points, regulatory vulnerabilities

### How to Use
1. **Select Mode**: Choose "Company Profile Generator" from the mode selector
2. **Enter Company Name**: Provide the name of the construction company
3. **Select County**: Choose from New Jersey or New York counties where the company operates
4. **Choose AI Model**: Select from GPT-4o (recommended), GPT-4o Mini, GPT-4, or GPT-3.5 Turbo
5. **Select Report Type**:
   - **Full Detailed Report** (30-50 pages): Comprehensive analysis with all sections
   - **Condensed Insights Report** (5-10 pages): Key findings and recent developments
   - **Change Alert Report** (2-5 pages): Specific changes or new developments
6. **Start Research**: The system will generate a comprehensive report following the Local 825 Company Profile Framework

### Report Framework
The company profile reports follow a standardized framework that includes:
- Executive summary with strategic assessment
- Detailed company overview and facility locations
- Leadership profiles and ownership structure
- Financial performance and project analysis
- Union relationships and labor history
- Safety and compliance records
- Legal issues and litigation history
- Political connections and community relationships
- Strategic analysis and recommendations for organizing efforts

### Research Sources
The system utilizes multiple data sources including:
- Government databases (OSHA, NLRB, federal/state procurement)
...
Follow these steps to get Local 825 Research up and running on your local browser.
...
4. **Run the development server:**
   ...
   Open your browser and visit [http://localhost:3000](http://localhost:3000) to access Local 825 Research.
...
As mentioned in the "Getting Started" section, Local 825 Research utilizes the following environment variables for server-side API configurations:
...
The Local 825 Research API provides a real-time interface for initiating and monitoring complex research tasks.
...
This is an interesting implementation. You can watch the whole process of research directly through the URL just like watching a video.

You can access the research report via the following link:
...
**Note:** Since research takes a long time to execute, you need to set a longer timeout to avoid interrupting the study.
...
# MCP Server thinking model id, the core model used in research.
...
- [AI SDKs](https://sdk.vercel.ai) - Powering the intelligent research capabilities of Local 825 Research.
- [Deep Research](https://github.com/dzhng/deep-research) - Thanks to the project `dzhng/deep-research` for inspiration.

## 🤝 Contributing

We welcome contributions to Local 825 Research! If you have ideas for improvements, bug fixes, or new features, please feel free to:
...
Local 825 Research is released under the [MIT License](LICENSE). This license allows for free use, modification, and distribution for both commercial and non-commercial purposes.
